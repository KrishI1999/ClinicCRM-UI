                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between flex-wrap gap-3">
                                    ...
                                    {(!visit.payment || visit.payment.status !== "Paid") && (
                                        <button
                                            onClick={() => {
                                                setSelectedVisit(visit);
                                                setShowPayment(true);
                                            }}
                                            className="flex items-center gap-1.5 bg-blue-600 text-white px-4 py-1.5 rounded-lg text-sm font-medium hover:bg-blue-700 transition"
                                        >
                                            + Add Payment
                                        </button>
                                    )}
